...
public class OauthAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
            Authentication authentication) throws IOException, ServletException {
              ...
              //set some attribute of user by default taht cant be extracted form following login method
              ...
              if(authorizedClientRegistrationId.equalsIgnoreCase("google")){
                ...
                user.setAbout("This acoount is created with google Oauthenticaton");
              ...
              user.setAbout("this account is created by github oauthentication");
